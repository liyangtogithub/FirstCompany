...
public class SleepChartView2 extends ChartView {
    ...
    public SleepChartView2(Context context, AttributeSet attributeSet) {
...
//                LogUtil.i("position="+position);
                ...
                if (nearPoint != null && nearPoint.getTag() != null)
                    if (nearPoint.getTag() instanceof SleepWeekServer.SleepDuration) {
                        ...
                        text1 = SystemContant.timeFormat10.format(tag.date);
...
//            LogUtil.i("l=" + SystemContant.timeFormat2.format(new Date((long) l + SystemContant.millisecondInDay)));
            double r = series.getActualXAxis().getScale().coefficientToValue(1);
//            LogUtil.i("r=" + SystemContant.timeFormat2.format(new Date((long) r)));
...
//            float textX = x - dialogW / 2 + dialogPadH;
    ...
    public void init() {
        ...
        axisX.setLabelFormat(new SimpleDateFormat("E"));
    ...
    private double getNearPointX(ChartSeries series, double position) {
        ...
        return nextPoint == null ? 0 : nextPoint.getX();
    }
